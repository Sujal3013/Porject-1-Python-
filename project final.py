...
'''...............................................................................................................................................................................'''
def create_database():
           mydb=mysql.connector.connect(host="localhost",user="root",charset = "utf8",passwd="TIGER",database="stock")				#change as per system
...
def add_order():
           ...
           cat=input("Enter product category(FOR EXAMPLE - ELECTRIC,FOOD,ETC): ")
           supplier=input("Enter Supplier details(FOR EXAMPLE - RAMMOHAN): ")           
...
def add_product():
           ...
           if cnt==0:
                      ...
                      qty=int(input("\t\tEnter product quantity (MAX. 4 DIGIT):"))
                      price=float(input("\t\tEnter product unit price :"))
                      cat=input("\t\tEnter Product category(FOR EXAMPLE - ELECTRIC,FOOD,ETC) :")
...
def update_product():
           mydb=mysql.connector.connect(host="localhost",user="root",charset = "utf8",passwd="TIGER",database="stock")
           mycursor=mydb.cursor()
           code=int(input("Enter the product code :"))
           qty=int(input("Enter the quantity :"))
           price = int(input("Enter the price :"))
           cat = input("Enter the category :")
           sql="UPDATE product SET pqty=pqty+%s,pprice=pprice+%s,pcat=%s  WHERE pcode=%s;"
           val=(qty,price,cat,code)
           mycursor.execute(sql,val)
           mydb.commit()
